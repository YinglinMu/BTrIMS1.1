PROGRAM back_traj
	...
	do dd = 1, totdays
        ...
        call calc_tpw_pbl(mixtot,pres,psfc,tpw_pbl,pbl_lev) !Yinglin: this is the total precipitable water within the boundary layer
